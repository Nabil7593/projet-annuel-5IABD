...
import type { DonutSlice, EvolutionSeries } from "./expenses-chart";
    ...
    <div className="rounded-[10px] bg-white px-6 pb-6 pt-7 shadow-1 dark:bg-gray-dark dark:shadow-card col-span-12 xl:col-span-6">
      <div className="mb-5 flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-sm text-dark-6 dark:text-dark-4 capitalize">{periodLabel} — par montant</p>
        </div>
            ...
            {donut.map((d) => (
              <div key={d.name} className="flex items-center justify-between text-xs">
                <span className="flex items-center gap-1.5 min-w-0">
                  ...
                  <span className="truncate text-dark-6 dark:text-dark-4">{d.name}</span>
                </span>
